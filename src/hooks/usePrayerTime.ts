...
export const AMBIENT_PALETTES: Record<PrayerPeriod, AmbientColors> = {
  ...
  isha: {
    ...
    bgAlt: '#16141e',
    surface: '#262430',
    warmth: 'rgba(160, 140, 100, 0.04)',
    accent: '#a89878',
    accentSubtle: 'rgba(168, 152, 120, 0.12)',
    textPrimary: '#e8e4dc',
    textSecondary: '#a8a098',
    textMuted: '#706860',
    border: 'rgba(168, 152, 120, 0.12)',
    borderSubtle: 'rgba(168, 152, 120, 0.06)',
    goldLeaf: '#d4b050',
    goldLeafSubtle: 'rgba(212, 176, 80, 0.14)',
  },
};
