      ...
      <main className="flex-1 flex items-center justify-center p-6 pb-28">
        ...
        >
          ...
          <p className="text-night-400 mb-6 leading-relaxed">
            We couldn't start your practice session. This might be a temporary 
            issue. Your progress and streaks are safely preserved.
          </p>
          ...
          <div className="mt-8 p-4 rounded-2xl bg-night-900/50 border border-night-800/50">
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="text-sm text-night-200 font-medium">Read Instead</p>
                <p className="text-xs text-night-400">
                  Continue reading the Quran
                </p>
              </div>
              <Link
                href="/mushaf"
