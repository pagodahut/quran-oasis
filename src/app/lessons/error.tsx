      ...
      <main className="flex-1 flex items-center justify-center p-6 pb-28">
        ...
        >
          ...
          <p className="text-night-400 mb-6 leading-relaxed">
            We had trouble loading your lessons. This might be a temporary issue. 
          ...
          <div className="mt-8 p-4 rounded-2xl bg-night-900/50 border border-night-800/50">
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="text-sm text-night-200 font-medium">While you wait</p>
                <p className="text-xs text-night-400">
                  Try practicing what you've already learned
                </p>
              </div>
              <Link
                href="/practice"
